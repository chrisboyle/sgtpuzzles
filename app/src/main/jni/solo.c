...
static config_item *game_configure(const game_params *params)
{
    ...
    ret[5].u.choices.choicenames = _(":None:2-way rotation:4-way rotation:2-way mirror:"
    ...
    ret[6].u.choices.choicenames = _(":Trivial:Basic:Intermediate:Advanced:Extreme:Unreasonable");
