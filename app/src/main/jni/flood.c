...
{
    android_keys("", ANDROID_ARROWS_LEFT);
}
#endif
...
{
#ifdef ANDROID
    if (newstate->complete && ! newstate->cheated && oldstate && ! oldstate->complete) android_completed();
#endif
}
...
const struct game thegame = {
    ...
    encode_ui,
    decode_ui,
    android_request_keys, /* android_request_keys */
    android_cursor_visibility, /* android_cursor_visibility */
    game_changed_state,
    interpret_move,
    execute_move,
